...
export class InfoDocsController {
  ...
  public async findCategories(
    ...
    return await this.infoDocsService.findCategories(
      categoriesTypesDto?.categories ?? defaultSort
    );
  }
  ...
  public async search(
    ...
    if (full) return await this.infoDocSearchService.searchAndPopulate(query);
